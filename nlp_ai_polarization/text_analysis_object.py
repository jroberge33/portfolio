'''
Jack Roberge, Zoe Garbus, Elsa Quinton, Luke Noble
April 7, 2025
Professor Rachlin
DS 3500
HW 6 / Project
...
'''
Note to TA: We spoke with Professor Rachlin about adding in functionality to our 
visualizations so that they can take a list of which files of the loaded files to 
graph given the amount of files we used. He confirmed this is okay for our situation
because of the amount (36) files each visualization would have to incorporate.  
Additionally, we included one more visualization function as we felt
word length didn't tell the complete story of a text's complexity and wanted to include
a more rigorous technique to measure text complexity. 
'''
